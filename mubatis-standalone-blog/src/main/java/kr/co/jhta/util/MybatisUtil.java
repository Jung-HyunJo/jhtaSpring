...
public class MybatisUtil {
	 ...
	 * 			Object 	selectList(String id, Object parameter)
	 * 			List 	selectList(String id)
	 * 			List 	selectList(String id, Object parameter)
	 * 			void 	close()
	 * 			void 	commit()
	 * 			void 	rollback()
	 * 			주의 사항) 쿼리를 한 번 실행할 때 마다 SqlSessionFactory로부터 새로운 SqlSession객체를
	 * 					  획득해서 사용하고, 폐기한다.
	 * 
	 * 		- SqlSessionFactory
	 ...
	 * 			SqlSessionFactory build(InputStream inputStram)
	 * 
	 * 
	 */
	...
	static {
		try {
			...
			//스트림을 이용해서 mybatis 환경설정파일을 읽어서 SqlSessionFactory객체 획득
